...
#### Prerequisites
  ...
  - Service Account in GCP with Editor role (Consider using least privilege, but we're in a hurry)
...
Since we need dummy -service in GCR; let's do it manually for now. (Not something I'm proud of)
- `cd ../dummy-pdf-or-png`
...
#### Deployment
- Commit to sre/iac folder master branch, GitHub Actions will provision infrastructure with Terraform
